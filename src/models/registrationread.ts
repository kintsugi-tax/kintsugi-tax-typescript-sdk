...
/** @internal */
export const RegistrationRead$inboundSchema: z.ZodType<
  RegistrationRead,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type RegistrationRead$Outbound = {
...
/** @internal */
export const RegistrationRead$outboundSchema: z.ZodType<
  RegistrationRead$Outbound,
  z.ZodTypeDef,
  RegistrationRead
> = z.object({
 ...
 */
export namespace RegistrationRead$ {
  /** @deprecated use `RegistrationRead$inboundSchema` instead. */
  export const inboundSchema = RegistrationRead$inboundSchema;
  /** @deprecated use `RegistrationRead$outboundSchema` instead. */
  export const outboundSchema = RegistrationRead$outboundSchema;
  /** @deprecated use `RegistrationRead$Outbound` instead. */
  export type Outbound = RegistrationRead$Outbound;
}

export function registrationReadToJSON(
  registrationRead: RegistrationRead,
): string {
  return JSON.stringify(
    RegistrationRead$outboundSchema.parse(registrationRead),
  );
}

export function registrationReadFromJSON(
  jsonString: string,
): SafeParseResult<RegistrationRead, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RegistrationRead$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RegistrationRead' from JSON`,
  );
}
