 ...
 */
export namespace PhysicalNexusCreate$ {
  /** @deprecated use `PhysicalNexusCreate$inboundSchema` instead. */
  export const inboundSchema = PhysicalNexusCreate$inboundSchema;
  /** @deprecated use `PhysicalNexusCreate$outboundSchema` instead. */
  export const outboundSchema = PhysicalNexusCreate$outboundSchema;
  /** @deprecated use `PhysicalNexusCreate$Outbound` instead. */
  export type Outbound = PhysicalNexusCreate$Outbound;
}
