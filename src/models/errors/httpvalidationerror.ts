...
export const HTTPValidationError$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  detail: z.array(models.ValidationError$inboundSchema).optional(),
...
export type HTTPValidationError$Outbound = {
  detail?: Array<models.ValidationError$Outbound> | undefined;
};
...
> = z.instanceof(HTTPValidationError)
  .transform(v => v.data$)
  .pipe(z.object({
    detail: z.array(models.ValidationError$outboundSchema).optional(),
  }));
