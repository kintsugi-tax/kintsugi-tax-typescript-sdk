 ...
 */
export function transactionsPUTUpdateCreditNoteByTransactionId(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.CreditNoteCreate, { explode: true });

  const pathParams = {
    credit_note_id: encodeSimple("credit_note_id", payload.credit_note_id, {
      explode: false,
      charEncoding: "percent",
    }),
    original_transaction_id: encodeSimple(
