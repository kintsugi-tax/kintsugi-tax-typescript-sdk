 ...
 */
export function exemptionsGetAttachmentsForExemptionV1ExemptionsExemptionIdAttachmentsGet(
  client: SDKCore,
  request:
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.AttachmentRead$inboundSchema)),
