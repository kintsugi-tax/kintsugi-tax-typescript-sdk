 ...
 */
export function customersUpdateCustomerV1CustomersCustomerIdPut(
  client: SDKCore,
  ...
  Result<
    ...
    | errors.BackendSrcCustomersResponsesValidationErrorResponse
    | SDKError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateCustomerV1CustomersCustomerIdPutRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v1/customers/{customer_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomerRead$inboundSchema),
    M.jsonErr([401, 404], errors.ErrorResponse$inboundSchema),
    M.jsonErr(
      422,
      errors.BackendSrcCustomersResponsesValidationErrorResponse$inboundSchema,
    ),
