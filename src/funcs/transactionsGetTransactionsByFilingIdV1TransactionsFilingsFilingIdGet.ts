 ...
 */
export function transactionsGetTransactionsByFilingIdV1TransactionsFilingsFilingIdGet(
  client: SDKCore,
  request:
...
> {
  ...
  const path = pathToFunc("/v1/transactions/filings/{filing_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.TransactionRead$inboundSchema)),
