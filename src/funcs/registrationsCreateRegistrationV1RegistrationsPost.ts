 ...
 */
export function registrationsCreateRegistrationV1RegistrationsPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateRegistration$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "409", "422", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr([401, 409], errors.ErrorResponse$inboundSchema),
    M.jsonErr(
      422,
      errors
