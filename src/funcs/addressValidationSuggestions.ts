 ...
 */
export function addressValidationSuggestions(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.ValidationAddress, { explode: true });

  const path = pathToFunc("/v1/address_validation/suggestions")();
