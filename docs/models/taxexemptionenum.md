...
```typescript
"PRODUCT" | "TRANSACTION" | "CUSTOMER" | "REGION" | "REVERSE_CHARGE" | "ZERO_RATE_TAX" | "HIGH_VALUE_PHYSICAL_GOODS" | "EXPORT" | "ZERO_VALUE_ITEM" | "NO_RULE_FOUND" | "IMPORTED" | "ZERO_RATE_NOT_EXEMPT"
```