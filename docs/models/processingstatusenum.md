...
```typescript
"NEW" | "UPDATED" | "QUEUED" | "ADDRESS_DONE" | "EXEMPT_DONE" | "NEXUS_DONE" | "PROCESSED" | "FILING_STARTED" | "FILING_DONE" | "LOCKED" | "PENDING" | "ARCHIVED" | "NEEDS_REFETCH" | "EXCLUDED_IN_CALCULATION"
```